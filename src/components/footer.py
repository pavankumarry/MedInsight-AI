...
from config.app_config import APP_NAME, PRIMARY_COLOR, SECONDARY_COLOR
    ...
    st.markdown(
        ...
        <div style='{base_styles}'>
            <p style='
                ...
                opacity: 0.95;
            '>
                {APP_NAME} &mdash; AI-powered health insights. Not a substitute for professional medical advice.
            </p>
        </div>
        """,
